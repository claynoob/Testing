...
namespace BLL
{
    public class Logic
    {
        ...
        public UserVM CreateUserVM(string lastName, string firstName, string email, DateTime dateOfBirth,
            string street, string city, string state, string zip, string addressType,
            string number, string phoneType)
        {
        ...
        public int GetEquipmentId(int categoryId, int typeId)
        {
            ...
            if (equipment == null)
            {
                ...
                equipment.id = dao.GetEquipment(categoryId, typeId).id;
            }
            return equipment.id;
        }
        public int GetUserId(int personAddressId, int personPhoneId)
        {
            ...
            if (user == null)
            {
                ...
                //user.id = dao.GetUser(personAddressId, personPhoneId).id;
                user.personAddressId = dao.GetUser(personAddressId, personPhoneId).personAddressId;
                user.personPhoneId = dao.GetUser(personAddressId, personPhoneId).personPhoneId;
            }
            return user.id;
        }
            ...
            string number, string phoneType)
        {
            ...
            order.equipmentId = SetEquipmentId(orderVm.category, orderVm.type);
